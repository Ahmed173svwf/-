...
// added or renamed.
const urlsToCache = [
  // Use relative paths so the service worker works whether the site is served
  // at the domain root (e.g. user.github.io) or a sub‑path (e.g. user.github.io/project/).
  './',
  './index.html',
  './program.html',
  './leader.html',
